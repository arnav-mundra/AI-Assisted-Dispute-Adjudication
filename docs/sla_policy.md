...
**SLA-COD-09.** If a COD mismatch claim is found to be fraudulent (customer previously
paid correct amount per multiple corroborating sources), the case should be flagged
for account-level review, not merely rejected.
