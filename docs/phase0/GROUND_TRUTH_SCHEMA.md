...
| Field | Purpose |
|---|---|
| `revision_note` | Why a finalized label was later changed, what it was before, and when. Required whenever a label is revised — a label that changes silently destroys the audit trail this schema exists to protect. |
